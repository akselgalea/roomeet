...
-- Volcando datos para la tabla roomeet.formas_contacto_user: ~3 rows (aproximadamente)
REPLACE INTO `formas_contacto_user` (`id`, `forma_id`, `link`, `user_id`) VALUES
	(2, 1, 'https://www.facebook.com', 1),
...
-- Volcando datos para la tabla roomeet.preferencias: ~2 rows (aproximadamente)
