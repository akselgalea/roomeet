...
class UserRoutes {
    ...
    config() {
        ...
        this.router.post('/buscador', verifyToken, userController_1.userController.buscador);
        ...
        this.router.post('/reportar', verifyToken, userController_1.userController.report);
        //User hobbies
        this.router.get('/hobbies/all', verifyToken, userController_1.userController.getHobbies);
        this.router.get('/hobbies', verifyToken, userController_1.userController.getMyHobbies);
        ...
        this.router.delete('/hobbies/remove/:id', verifyToken, userController_1.userController.removeHobbie);
        ...
        this.router.post('/images/:id', verifyToken, userController_1.userController.deleteImage);
        ...
        this.router.put('/contacto/:id', verifyToken, userController_1.userController.updateInfoContacto);
